...
const Blog = () => {
    return (
        <div>
                <h2 className= 'fw-bold text-primary mt-4'>Blog Section</h2>
            <div>
                <div className='QA'>
                    <h3 className='fw-bold'>Question-01 : What is cors?</h3>
                ...
                <div className='QA'>
                 ...
                 <div className='QA'>
                    <h3 className='fw-bold'>Question-04 : What is Node? How does Node work?</h3>
                    <p>Node.js is an open-source, cross-platform, back-end JavaScript runtime environment that runs on a JavaScript Engine and executes JavaScript code outside a web browser, which was designed to build scalable network applications <br />Node is a used as backend service where javascript works on the server-side of the application. This way javascript is used on both frontend and backend. Node. js runs on chrome v8 engine which converts javascript code into machine code, it is highly scalable, lightweight, fast, and data-intensive. </p>
                 </div> 
            </div>
